...
namespace ac {
    ...
    public:
		...
		HRESULT initVertexShader(ID3D11Device* device, const std::wstring& path, const std::string& entryPoint = "main", const std::string& target = "vs_5_0") {
            _vertexShaderBlob = compileShader(path, entryPoint, target);
        ...
        HRESULT initPixelShader(ID3D11Device* device, const std::wstring& path, const std::string& entryPoint = "main", const std::string& target = "ps_5_0") {
            _pixelShaderBlob = compileShader(path, entryPoint, target);
